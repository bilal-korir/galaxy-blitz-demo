...
export default function MenuSlider({ toggleMenuOpen, isMenuOpen }) {
  return (
    <div
      className={`z-50 font-patron uppercase absolute right-0 top-0 bottom-0 w-fit shadow-lg transition duration-300	ease-linear ${
